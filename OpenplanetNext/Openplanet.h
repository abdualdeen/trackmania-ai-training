// Maniaplanet engine classes documentation for 2022-11-16 05:57:19
// Generated with Openplanet 1.25.15 (next, Public, 2022-09-29)
...
struct CGameCtnCollection : public CMwNod {
  ...
  CPlugBitmap* BitmapDisplayControlDefaultTVProgram_16x9;
...
struct CGamePlayerInfo : public CGameNetPlayerInfo {
  ...
  const wstring Model_HelmetPilot_SkinName; // Maniascript
  const string Model_HelmetPilot_SkinUrl; // Maniascript
...
struct CGameClientTrackingScript : public CMwNod {
  ...
  void Track_Live_RoyalSectionFinished(MwId UserId, uint Color); // Maniascript
  ...
  void Track_News_PlayerAction(MwId UserId, string NewsId); // Maniascript
  void Track_News_PlayerImpression(MwId UserId, string NewsId); // Maniascript
...
struct CGameCtnCampaign : public CMwNod {
  ...
  uint NbGoldMedals;
  uint NbAuthorMedals;
  const CGameCtnCampaign::EMedal Medal;
...
struct CGameCtnGhost : public CGameGhost {
  ...
  wstring ModelIdentCollection_Text;
  const uint TmInputsDuration;
  string GhostLogin;
  string GhostTrigram;
  wstring GhostCountryPath;
  wstring GhostNickname;
  bool GhostIsFirstPartyDisplayName;
  ...
  const string Validate_ScopeType;
  const string Validate_ScopeId;
  const string Validate_GameMode;
  const string Validate_GameModeCustomData;
  const string Validate_ExeVersion;
  const uint Validate_ExeChecksum;
  const string Validate_TitleId;
  const string Validate_ExtraTool_Info;
...
struct CGameManiaPlanetScriptAPI : public CMwNod {
  ...
  const wstring Language_Current; // Maniascript
  wstring Language_NextStart; // Maniascript
...
struct CGameManialinkLabel : public CGameManialinkControl {
  ...
  void TTS_Read(); // Maniascript
  void TTS_Focused(); // Maniascript
  wstring TTS_AltText; // Maniascript
  void TTS_Focused_Prio(bool IsLowPrio); // Maniascript
};
...
struct CGameCtnEditorCommon : public CGameCtnEditor {
  ...
  void SweepAnimatedBlocksAndSave();
  void SweepAnimatedItemsAndSave();
  void SweepAnimatedMacroBlocksAndSave();
...
struct CGameEditorPluginMap : public CGameManiaApp {
  ...
  CGameEditorMapMacroBlockInstance* CreateMacroblockInstance(CGameCtnMacroBlockInfo* MacroblockModel, nat3 Coord, CGameEditorPluginMap::ECardinalDirections Dir); // Maniascript
  CGameEditorMapMacroBlockInstance* CreateMacroblockInstanceWithUserData(CGameCtnMacroBlockInfo* MacroblockModel, nat3 Coord, CGameEditorPluginMap::ECardinalDirections Dir, int UserData); // Maniascript
  CGameEditorMapMacroBlockInstance* CreateMacroblockInstanceWithClipList(CGameCtnMacroBlockInfo* MacroblockModel, nat3 Coord, CGameEditorPluginMap::ECardinalDirections Dir, CGameEditorMapScriptClipList* DefaultClipList); // Maniascript
  CGameEditorMapMacroBlockInstance* CreateMacroblockInstanceWithClipListAndUserData(CGameCtnMacroBlockInfo* MacroblockModel, nat3 Coord, CGameEditorPluginMap::ECardinalDirections Dir, CGameEditorMapScriptClipList* DefaultClipList, int UserData); // Maniascript
...
struct CGameScriptServerAdmin : public CMwNod {
  ...
  const string PlatformRestriction; // Maniascript
};
...
struct CGameManiaApp : public CMwNod {
  ...
  void TTS_Context_Leave(MwId ContextId); // Maniascript
  ...
  void TTS_Context_Read(int Level); // Maniascript
};
...
struct CTmRaceResultNod : public CMwNod {
  ...
  UnknownType Checkpoints; // Maniascript
...
struct CGameMenuSceneScriptManager : public CMwNod {
  ...
  MwId ItemCreate(MwId SceneId, wstring ModelName, wstring SkinName, string SkinUrl); // Maniascript
...
// File extension: 'ScoreAndLeaderBoard.Gbx'
struct CGameScoreAndLeaderBoardCache : public CMwNod {
  CGameScoreAndLeaderBoardCache();
...
struct CGameScoreAndLeaderBoardManagerScript : public CMwNod {
  ...
  CGameScoreAndLeaderBoardManagerScript::ELocalScoreStatus ScoreStatus_GetLocalStatusForContext(MwId UserId, string ScopeType, string ScopeId, string GameMode, string GameModeCustomData); // Maniascript
  CGameScoreAndLeaderBoardManagerScript::EMasterServerScoreStatus ScoreStatus_GetMasterServerStatus(MwId UserId); // Maniascript
  CGameScoreAndLeaderBoardManagerScript::EMasterServerScoreStatus ScoreStatus_GetMasterServerStatusForContext(MwId UserId, string ScopeType, string ScopeId, string GameMode, string GameModeCustomData); // Maniascript
  ...
  CWebServicesTaskResult* Map_SetNewRecord_v2(MwId UserId, string MapUid, string GameMode, string GameModeCustomData, CGameGhostScript* Ghost); // Maniascript
  ...
  uint Map_GetMultiAsyncLevel_v2(MwId UserId, string MapUid, string ScopeType, string ScopeId, string GameMode, string GameModeCustomData); // Maniascript
  ...
  uint Map_GetSkillPoints_v2(MwId UserId, string MapUid, string ScopeType, string ScopeId, string GameMode, string GameModeCustomData); // Maniascript
  ...
  CWebServicesTaskResult_Natural* MapLeaderBoard_GetPlayerRankingAsync(MwId UserId, string MapUid, string Context, wstring Zone); // Maniascript
  ...
  CWebServicesTaskResult_Natural* CampaignLeaderBoard_GetPlayerRankingAsync(MwId UserId, string CampaignId, wstring Zone, bool UseSkillPoints); // Maniascript
  ...
  CWebServicesTaskResult_MapRecordListScript* Season_GetOpponentRecordList(MwId UserId, string SeasonId, string OpponentWebServicesUserId); // Maniascript
...
struct CGameUserPrivilegesManagerScript : public CMwNod {
  enum class CGameUserPrivilegesManagerScript::EPrivilege {
    ...
    CrossPlay = 4,
    DownloadUserCreatedContent = 5,
    PlayMultiplayerAsync = 6,
    PlayMultiplayerAsyncWithUGC = 7,
    PlayMultiplayerMode = 8,
    PlayMultiplayerModeWithUGC = 9,
    PlayMultiplayerSession = 10,
    PlayMultiplayerSessionWithUGC = 11,
    UploadUserCreatedContent = 12,
    UseUserCreatedContent = 13,
    UseUserCreatedContentRequired = 14,
    ViewOnlinePresence = 15,
    ViewUserCreatedContent = 16,
    ViewUserCreatedContentRequired = 17,
    ViewUserGameHistory = 18,
    VoiceChat = 19,
  };
  const MwFastBuffer<CWebServicesTaskResult*> TaskResults; // Maniascript
  void TaskResult_Release(MwId TaskId); // Maniascript
...
struct CWebServicesTaskResult_NaturalLeaderBoardInfoListScript : public CWebServicesTaskResult_NaturalLeaderBoardInfoList {
  ...
  const uint Count; // Maniascript
  const MwFastBuffer<CGameNaturalLeaderBoardInfoScript*> LeaderBoardInfo; // Maniascript
};
...
struct CWebServicesTaskResult_RealLeaderBoardInfoListScript : public CWebServicesTaskResult_RealLeaderBoardInfoList {
  const uint FromIndex; // Maniascript
  const uint Count; // Maniascript
  const MwFastBuffer<CGameRealLeaderBoardInfoScript*> LeaderBoardInfo; // Maniascript
};
...
struct CGameScoreTask_GetPlayerMapRecordList : public CWebServicesTaskSequence {
};

// Description: "Task result containing a list of map record info from NadeoServices."
struct CWebServicesTaskResult_MapRecordListScript : public CWebServicesTaskResult_MapRecordList {
...
struct CGameScoreTask_GetNaturalLeaderBoardSummaries : public CWebServicesTaskSequence {
};

struct CGameScoreTask_GetRealLeaderBoardSummaries : public CWebServicesTaskSequence {
};
...
struct CGameScoreTask_GetCampaignRanking : public CWebServicesTaskSequence {
};

struct CGameScoreTask_GetMapRanking : public CWebServicesTaskSequence {
};

struct CWebServicesTaskResult_PlayerRanking : public CWebServicesTaskResult {
};
...
struct CGameScoreTask_LoadSeasonScore : public CWebServicesTaskSequence {
};

struct CGameSeasonScoreManager : public CMwNod {
};

struct CGameSeasonLeaderBoard : public CGameNaturalLeaderBoard {
};
...
struct CGameScoreTask_GetPlayerListMapRecordList : public CWebServicesTaskSequence {
};
...
struct CGameUserTask_CrossPlay_GetEnabled : public CWebServicesTaskSequence {
};
...
struct CGameScoreTask_LoadSeasonScoreList : public CWebServicesTaskSequence {
};

struct CGameScoreTask_SynchronizePlayerSeasonScoreList : public CWebServicesTaskSequence {
};
...
struct CWebServicesTaskResult_FriendList : public CWebServicesTaskResult {
};

// Description: "Task result containing a list of friend info."
struct CWebServicesTaskResult_FriendListScript : public CWebServicesTaskResult_FriendList {
...
struct CGameUserTask_Friend_GetList : public CWebServicesTaskSequence {
};
...
struct CGameUserTask_Squad_Leave : public CGameUserTask_Squad_AbstractTask {
};
...
struct CGameUserTask_Tag_SetClubTag : public CWebServicesTaskSequence {
};
...
struct CPlugSoundEngine2 : public CPlugSound {
  ...
  SPlugCurveSimpleInPlace7 AudioMotors_PitchRandomize_Rpm;
  SPlugCurveSimpleInPlace7 AudioMotors_PitchRandomize_Rpm;
  SPlugCurveSimpleInPlace7 AudioMotors_PitchRandomize_Throttle;
  ...
  float RpmGamma;
  SPlugCurveSimpleInPlace7 Volume_Speed;
  SPlugCurveSimpleInPlace7 Volume_Distance;
  SPlugCurveSimpleInPlace7 Volume_Rpm;
  SPlugCurveSimpleInPlace7 Volume_Throttle;
  SPlugCurveSimpleInPlace7 Volume_Gear;
  SPlugCurveSimpleInPlace7 RpmFactor_Gear;
  SPlugCurveSimpleInPlace7 VolPersp_Rpm_Exhaust;
  SPlugCurveSimpleInPlace7 VolPersp_Throttle_Exhaust;
  SPlugCurveSimpleInPlace7 VolPersp_Rpm_Engine;
  SPlugCurveSimpleInPlace7 VolPersp_Throttle_Engine;
  SPlugCurveSimpleInPlace7 VolPersp_Rpm_Interior;
  SPlugCurveSimpleInPlace7 VolPersp_Throttle_Interior;
...
struct CPlugSoundGauge : public CPlugSound {
  ...
  SPlugCurveSimpleInPlace7 PitchFromRateFilling;
  SPlugCurveSimpleInPlace7 PitchFromRateEmptying;
  SPlugCurveSimpleInPlace7 PitchFromRateOnStopFilling;
  SPlugCurveSimpleInPlace7 PitchFromRateOnStopEmptying;
  SPlugCurveSimpleInPlace7 PitchFromRateOnStartFilling;
  SPlugCurveSimpleInPlace7 PitchFromRateOnStartEmptying;
  SPlugCurveSimpleInPlace7 PitchFromRateOnFullOrEmpty;
  SPlugCurveSimpleInPlace7 PitchFromRateOnGradFull;
  SPlugCurveSimpleInPlace7 PitchFromRateOnGradEmpty;
  SPlugCurveSimpleInPlace7 PitchFromRatioFilling;
  SPlugCurveSimpleInPlace7 PitchFromRatioEmptying;
  SPlugCurveSimpleInPlace7 PitchFromRatioOnStopFilling;
  SPlugCurveSimpleInPlace7 PitchFromRatioOnStopEmptying;
  SPlugCurveSimpleInPlace7 PitchFromRatioOnStartFilling;
  SPlugCurveSimpleInPlace7 PitchFromRatioOnStartEmptying;
  SPlugCurveSimpleInPlace7 PitchFromRatioOnFullOrEmpty;
  SPlugCurveSimpleInPlace7 PitchFromRatioOnGradFull;
  SPlugCurveSimpleInPlace7 PitchFromRatioOnGradEmpty;
  SPlugCurveSimpleInPlace7 VolumeFromRateFilling;
  SPlugCurveSimpleInPlace7 VolumeFromRateEmptying;
  SPlugCurveSimpleInPlace7 VolumeFromRateOnStopFilling;
  SPlugCurveSimpleInPlace7 VolumeFromRateOnStopEmptying;
  SPlugCurveSimpleInPlace7 VolumeFromRateOnStartFilling;
  SPlugCurveSimpleInPlace7 VolumeFromRateOnStartEmptying;
  SPlugCurveSimpleInPlace7 VolumeFromRateOnFullOrEmpty;
  SPlugCurveSimpleInPlace7 VolumeFromRateOnGradFull;
  SPlugCurveSimpleInPlace7 VolumeFromRateOnGradEmpty;
  SPlugCurveSimpleInPlace7 VolumeFromRatioFilling;
  SPlugCurveSimpleInPlace7 VolumeFromRatioEmptying;
  SPlugCurveSimpleInPlace7 VolumeFromRatioOnStopFilling;
  SPlugCurveSimpleInPlace7 VolumeFromRatioOnStopEmptying;
  SPlugCurveSimpleInPlace7 VolumeFromRatioOnStartFilling;
  SPlugCurveSimpleInPlace7 VolumeFromRatioOnStartEmptying;
  SPlugCurveSimpleInPlace7 VolumeFromRatioOnFullOrEmpty;
  SPlugCurveSimpleInPlace7 VolumeFromRatioOnGradFull;
  SPlugCurveSimpleInPlace7 VolumeFromRatioOnGradEmpty;
};
...
struct CPlugShaderPass : public CPlug {
  ...
  const UnknownType VertexTextures;
...
struct CPlugSoundEngine : public CPlugSound {
  ...
  SPlugCurveSimpleInPlace7 Volume_Distance;
  SPlugCurveSimpleInPlace7 Volume_Rpm;
  SPlugCurveSimpleInPlace7 Volume_Accel;
  SPlugCurveSimpleInPlace7 Alpha_Speed;
  SPlugCurveSimpleInPlace7 Alpha_Distance;
  SPlugCurveSimpleInPlace7 Alpha_Rpm;
  SPlugCurveSimpleInPlace7 Alpha_Accel;
};
...
struct CPlugAnimFile : public CMwNod {
  ...
  UnknownType GraphContextClassIds;
  MwFastBuffer<CPlugAnimRigNode_Graph*> NodeGraphs;
...
struct CPlugBulletModel : public CMwNod {
  ...
  float Speed;
  SPlugCurveSimpleInPlace7 SpeedFromHorizonAngle;
  float GunSpeedCoef;
  ...
  SPlugCurveSimpleInPlace7 DamageAttenuationFromDist;
  ...
  SPlugCurveSimpleInPlace7 ExplosionRadiusCoefFromLifeTime;
  ...
  SPlugCurveSimpleInPlace7 ExplosionEnergyFromLifeTime;
  ...
  SPlugCurveSimpleInPlace7 SpeedFromTriggerDuration;
  uint AmmoCostDuringTriggerDuration;
  SPlugCurveSimpleInPlace7 SpreadCoefFormChargeDuration;
  uint FirePeriod;
  uint FireEnergyCost;
  ...
  SPlugCurveSimpleInPlace7 SoundAliveVolumeFromRemainingLifeTime;
  SPlugCurveSimpleInPlace7 SoundAlivePitchFromRemainingLifeTime;
  SPlugCurveSimpleInPlace7 SoundFireVolumeFromRemainingAmmo;
  SPlugCurveSimpleInPlace7 SoundFirePitchFromRemainingAmmo;
...
struct CPlugVisEntFxModel : public CMwNod {
  ...
  SPlugCurveSimpleInPlace7 EliminatedTeleportIntens;
  SPlugCurveSimpleInPlace7 EliminatedHighlight;
...
struct CPlugTrainWagonModel : public CMwNod {
  ...
  bool IsLoco;
  bool IsAutopiloted;
  SPlugCurveSimpleInPlace7 AccelCurve;
  float LinearMass;
...
struct CPlugAnimClipBaked : public CMwNod {
  ...
  MwFastBuffer<GmTransQuat> LocalJointsData;
  MwFastBuffer<GmTransYaw> RootMotionFrames;
  MwFastBuffer<MwId> FloatChannelIds;
  MwFastBuffer<float> FloatChannelData;
};
...
struct CPlugAnimChannelGroup : public CMwNod {
  ...
  MwFastBuffer<MwId> JointNames;
  MwFastBuffer<float> JointWeights;
  CPlugSkel* OldSkel;
...
struct CPlugCurveSimpleNod : public CMwNod {
  ...
  SPlugCurveSimpleInPlace7 Curve;
};
...
struct CSceneVehicleVisState {
  ...
  const ESceneVehicleVisEvent EventType;
};
...
struct CSceneCharVisState {
  ...
  int8 SeatTypeNum;
  const ESceneCharVisNotice EventType;
};
...
struct CVisionViewport : public CHmsViewport {
  ...
  UnnamedEnum ColorBlindlessCorrection;
  float ColorBlindlessCorrection_Intensity; // Range: 0 - 1
  const MwFastBuffer<CVisionVideoDecode*> VideoDecodes;
};
...
struct CNetUbiServicesTask_LaunchUbisoftClub : public CNetUbiServicesTask {
};
...
struct CWebServicesTask_LaunchUbisoftClub : public CWebServicesTaskSequence {
};
...
struct CNetUbiServicesTask_RequestUplayProfiles : public CNetUbiServicesTask {
};

struct CNetUbiServicesTask_RequestFirstPartyProfiles : public CNetUbiServicesTask {
};
...
struct CSmArenaClient : public CGamePlaygroundCommon {
  ...
  SPlugCurveSimpleInPlace7 PredictionSmoothFromExtrapolationDuration;
...
struct CSmArenaScore : public CGamePlaygroundScore {
  ...
  const MwFastBuffer<int> BestRaceTimes; // Maniascript
  const MwFastBuffer<int> PrevRaceTimes; // Maniascript
  const MwFastBuffer<int> BestLapTimes; // Maniascript
  const MwFastBuffer<int> PrevLapTimes; // Maniascript
...
struct CSmArenaRulesMode : public CGamePlaygroundScript {
  ...
  void SetGameModeNameAndCustomData1(string GameModeName); // Maniascript
  void SetGameModeNameAndCustomData2(string GameModeName, string Leaderbord_CustomData); // Maniascript
  void SetGameModeNameAndCustomData3(string GameModeName, string Leaderbord_CustomData, string GhostDriver_CustomData); // Maniascript
...
struct CSmScriptPlayer : public CGameScriptPlayer {
  ...
  const MwFastBuffer<int> RaceWaypointTimes; // Maniascript
  const MwFastBuffer<int> LapWaypointTimes; // Maniascript
  const MwFastBuffer<int> CurrentLapWaypointTimes; // Maniascript
  const MwFastBuffer<int> PreviousLapWaypointTimes; // Maniascript
...
struct CPlugAnimRigNode_JointInertia : public CPlugGraphNode {
  CPlugAnimRigNode_JointInertia();
...
struct CPlugAnimRigNode_AirTrajectoryPrediction : public CPlugGraphNode {
  CPlugAnimRigNode_AirTrajectoryPrediction();
...
struct CScenePhyReplay : public CMwNod {
  CScenePhyReplay();
...
struct CPlugAnimRigNode_JointRotateFrom : public CPlugGraphNode {
  CPlugAnimRigNode_JointRotateFrom();
...
struct CPlugAnimRigNode_JointRotate : public CPlugGraphNode {
  CPlugAnimRigNode_JointRotate();
  ...
  ERotationOrder Rotation_Order;
  ERigNodeOperationType Operator;
  ERigNodeAxisWorkspace Axis_Workspace;
};

struct CPlugAnimRigNode_JointAlignTo : public CPlugGraphNode {
  CPlugAnimRigNode_JointAlignTo();
...
struct CPlugAnimRigNode_JointTranslate : public CPlugGraphNode {
  CPlugAnimRigNode_JointTranslate();
...
struct CPlugAnimRigNode_JointIK2 : public CPlugGraphNode {
  CPlugAnimRigNode_JointIK2();

  MwId Begin_Joint;
  MwId Middle_Joint;
  MwId End_Joint;
  string WeightIK2_Expr;
  bool Keep_End_Joint_Global_Rotation;
  ERigNodeIK2SolverMode SolverMode;
  string PoleVector_Expr;
  string Weight_SolverAuto_Expr;
  bool SoftIK;
  string Weight_SoftIK_Expr;
};

struct CPlugAnimRigNode_JointKeepRefGlobalRot : public CPlugGraphNode {
  CPlugAnimRigNode_JointKeepRefGlobalRot();

  MwId Joint;
  bool UpdateChilds;
};

struct CPlugAnimRigNode_JointTranslateDistConstraint : public CPlugGraphNode {
  CPlugAnimRigNode_JointTranslateDistConstraint();
...
struct CPlugAnimRigNode_LocalToGlobal : public CPlugGraphNode {
  CPlugAnimRigNode_LocalToGlobal();

};

struct CPlugAnimRigNode_Blend : public CPlugGraphNode {
  CPlugAnimRigNode_Blend();
...
struct CPlugAnimRigNode_ClipPlay : public CPlugGraphNode {
  CPlugAnimRigNode_ClipPlay();
  ...
  EClipPlayAdditiveType Additive_Type;
};

struct CPlugAnimRigNode_Blend2d : public CPlugGraphNode {
  CPlugAnimRigNode_Blend2d();

};

struct CPlugAnimRigNode_Graph : public CPlugGraphNode_Graph {
  CPlugAnimRigNode_Graph();
...
struct CPlugAnimRigNode_StateMachine : public CPlugGraphNode_StateMachine {
  CPlugAnimRigNode_StateMachine();
...
struct CPlugAnimRigNode_LodSwitch : public CPlugGraphNode {
  CPlugAnimRigNode_LodSwitch();

};

struct CPlugAnimRigNode_Group : public CPlugGraphNode_Group {
  CPlugAnimRigNode_Group();

};

struct CPlugAnimRigNode_RefLocalPose : public CPlugGraphNode {
  CPlugAnimRigNode_RefLocalPose();

};

struct CPlugAnimRigNode_GraphOutput : public CPlugGraphNode {
  CPlugAnimRigNode_GraphOutput();
...
struct CPlugAnimRigNode_ExtractMotion : public CPlugGraphNode {
  CPlugAnimRigNode_ExtractMotion();

  MwId Joint_Name;
  EExtractMotionMode Mode;
  MwId Trans_VarName;
  MwId Rot_VarName;
  bool Force_Rotation_Order;
  ERotationOrder Rotation_Order;
  bool Remove_From_Pose;
  bool Extract_From_Linked_Rig;
  bool Extract_From_A_pose;
  MwId Status_VarName;
};

struct CPlugAnimRigNode_RefGlobalPose : public CPlugGraphNode {
  CPlugAnimRigNode_RefGlobalPose();
...
struct CPlugAnimRigNode_SetVar : public CPlugGraphNode {
  CPlugAnimRigNode_SetVar();
...
struct CPlugAnimRigNode_ClipGroupPlay : public CPlugGraphNode {
  CPlugAnimRigNode_ClipGroupPlay();
...
struct CPlugAnimRigNode_SetSkel : public CPlugGraphNode {
  CPlugAnimRigNode_SetSkel();
...
struct CPlugAnimRigNode_LayeredBlend : public CPlugGraphNode {
  CPlugAnimRigNode_LayeredBlend();

  MwId ChannelGroup_Name;
  string Layer_Weight_Expr;
  ELayeredBlendType Blend_Type;
  ELayeredBlendContext Trans;
  ELayeredBlendContext Rot;
};

struct CPlugAnimRigNode_GlobalToLocal : public CPlugGraphNode {
  CPlugAnimRigNode_GlobalToLocal();

};

struct CPlugAnimRigNode_PoseGrid : public CPlugGraphNode {
  CPlugAnimRigNode_PoseGrid();
...
struct CPlugAnimRigNode_GraphInput : public CPlugGraphNode {
  CPlugAnimRigNode_GraphInput();
...
struct CPlugAnimRigNode_JointLock : public CPlugGraphNode {
  CPlugAnimRigNode_JointLock();

  MwId Joint;
  ERigNodeLockWorkspace Lock_Workspace;
  MwId Custom_Joint;
  ERigNodeLockType Lock_Type;
...
struct CPlugAnimRigNode_DebugHelper : public CPlugGraphNode {
  CPlugAnimRigNode_DebugHelper();

  string Point_A_Expr;
  string Point_B_Expr;
};

struct CPlugAnimRigNode_AssertVar : public CPlugGraphNode {
  CPlugAnimRigNode_AssertVar();

  string Variable;
  string Expected_value;
  ERigNodeAssertVarType Type_of_the_var_to_assert;
  string Epsilon;
};

struct CPlugAnimRigNode_Funnel : public CPlugGraphNode {
  CPlugAnimRigNode_Funnel();
...
struct CPlugAnimRigNode_ExtractUnit : public CPlugGraphNode {
  CPlugAnimRigNode_ExtractUnit();

  MwId Joint_Name;
  EExtractMotionMode Mode;
  EExtractUnitTarget Motion_targeted;
  EExtractUnitAxis Axis;
  bool Force_Rotation_Order;
  ERotationOrder Rotation_Order;
  MwId VarName;
  MwId Status_VarName;
...
struct CPlugAnimRigNode_SetJointExpr : public CPlugGraphNode {
  CPlugAnimRigNode_SetJointExpr();

  MwId Joint_Expr_Group_Name;
};

struct CPlugAnimRigNode_JointTransConstraint : public CPlugGraphNode {
  CPlugAnimRigNode_JointTransConstraint();
...
struct CPlugAnimRigNode_JointRotConstraint : public CPlugGraphNode {
  CPlugAnimRigNode_JointRotConstraint();
...
struct CNotification_SquadDeleted : public CNotification {
  const string SquadId; // Maniascript
  const string SquadType; // Maniascript
  const uint TimeStamp; // Maniascript
};

struct CNotification_SquadInvitationAccepted : public CNotification {
...
struct CNotification_SquadInvitationAdded : public CNotification {
  const string InvitedAccountId; // Maniascript
  const string InvitedCountryFlagUrl; // Maniascript
  const wstring InvitedDisplayName; // Maniascript
  const bool InvitedIsFirstPartyDisplayName; // Maniascript
...
struct CNotification_SquadInvitationCanceled : public CNotification {
...
struct CNotification_SquadInvitationCanceledForExitingPlayer : public CNotification {
  const string InvitedAccountId; // Maniascript
  const string InvitedCountryFlagUrl; // Maniascript
  const wstring InvitedDisplayName; // Maniascript
  const bool InvitedIsFirstPartyDisplayName; // Maniascript
...
struct CNotification_SquadInvitationCanceledForFullSquad : public CNotification {
  const string InvitedAccountId; // Maniascript
  const string InvitedCountryFlagUrl; // Maniascript
  const wstring InvitedDisplayName; // Maniascript
  const bool InvitedIsFirstPartyDisplayName; // Maniascript
...
struct CNotification_SquadInvitationDeclined : public CNotification {
  const string InvitedAccountId; // Maniascript
  const string InvitedCountryFlagUrl; // Maniascript
  const wstring InvitedDisplayName; // Maniascript
  const bool InvitedIsFirstPartyDisplayName; // Maniascript
...
struct CNotification_SquadInvitationReceived : public CNotification {
  const string InviterAccountId; // Maniascript
  const string InviterCountryFlagUrl; // Maniascript
  const wstring InviterDisplayName; // Maniascript
  const bool InviterIsFirstPartyDisplayName; // Maniascript
...
struct CNotification_SquadMemberKicked : public CNotification {
...
struct CNotification_SquadMemberRemoved : public CNotification {
  const string MemberAccountId; // Maniascript
  const string MemberCountryFlagUrl; // Maniascript
  const wstring MemberDisplayName; // Maniascript
  const bool MemberIsFirstPartyDisplayName; // Maniascript
...
struct NGameEditorMap_SExperimentalFeatures {
  ...
  bool AreAnimatedModesAvailable;
...
struct SPlugCurveSimpleInPlace7 : public SPlugCurveSimple {
};
...
struct NGamePodium_SMgr {
  NGamePodium_SConfig Config;
  vec3 PodiumLoc_ItemOffset;
  CGamePodiumInfo* PodiumInfo;
};
...
struct NSceneDynaAnimated_SMgr {
  MwFastBuffer<NSceneDynaAnimated_SSceneDynaAnimationModel> AnimationModels;
  MwFastBuffer<NSceneDynaAnimated_SSceneDynaAnimated> AnimatedDynas;
};
...
struct NSceneAdvert_SMgr {
  MwFastBuffer<NSceneAdvert_SBillboard> Billboards;
...
struct NSceneAnim_SMgr {
  ...
  MwFastBuffer<NSceneAnim_SRig> Rigs;
};
...
struct CGameCtnMediaBlockEntity_SuperSKeyVal {
  enum class CGameCtnMediaBlockEntity_SuperSKeyVal::EForceLight {
    Auto = 0,
    On = 1,
    Off = 2,
  };
  ...
  float Start_Offset;
  bool Force_Hue;
  CGameCtnMediaBlockEntity_SuperSKeyVal::EForceLight Lights;
...
struct NGameVideoSource_SMgr {
  UnknownType ApiNames;
  UnknownType SourceNames;
  string SelApiName;
...
struct NGameMapAnimatedElems_SSpawnParam {
  GmTransYawPitchRoll Start;
  GmTransYawPitchRoll End;
};

struct NPlugItemPlacement_SClass {
...
struct NSceneDynaAnimated_SSceneDynaAnimationModel {
};

struct NSceneDynaAnimated_SSceneDynaAnimated {
};
...
struct NSceneAdvert_SBillboard {
  iso4 Screen_Box_m_Location;
  vec3 Screen_Box_m_Scale;
};
...
struct NSceneAnim_SRig {
  NSceneAnim_SModel* Model;
  NSceneAnim_SRigInput Input;
};

struct NSceneAnim_SEdRigContext {
...
struct NSceneAnim_SRigNodeState_StateMachine {
  uint16 State;
  uint16 PrevState;
  uint StateStartTime;
};
...
struct NSceneAnim_SClipPlayerInput : public NSceneAnim_SRigInputBase {
};

struct NSceneAnim_SRigInputBase {
  int Lod; // Range: -1 - 2
};

struct NSceneAnim_SRigInput : public NSceneAnim_SRigInputBase {
  UnknownType Contexts;
};

struct NSceneAnim_SRigNodeUpdateContextParams {
  uint Time;
  float Period;
  uint iLod;
...
struct NSceneSpectatorVis_SInput {
  uint PlaygroundSpectatorCount;
  uint PreviewSpectatorCount;
  float PreviewSpectatorPercent;
  bool PlaygroundForceHide;
};
...
struct NPlugItemPlacement_SPatchLayoutDeprec {
  ...
  EFillDir FillOrder;
  ESiblingDistribution SiblingDistribution;
...
struct NPlugClassicSkin_SModel_SFxSystem {
  float EmitterLinearHue01;
  float EmitterHueLightness;
};

struct NPlugClassicSkin_SModel {
  NPlugClassicSkin_SModel_SFxSystem FxSystem;
};

struct NPlugMatRemap_SModel {
};

struct NPlugParallaxScreen_SModel {
  UnknownType Layers;
};

struct NPlugParallaxScreen_SModel_Layer {
  string Name;
  float Depth;
  bool HasVerticalTiling;
};

struct NPlugSkinManialink_SModel {
...
struct NPlugModelKit_SModelAssets {
  ...
  MwSArray<NPlugModelKit_SOptionVal> Signature;
  uint cRef;
};
...
struct NPlugModelKit_SPartFilesVersion {
  MwSArray<NPlugModelKit_SOptionVal> OptionVals;
  uint Files;
};
...
struct NPlugModelKit_SPartPaths {
  ...
  SConstString ShadingFolder0;
  SConstString ShadingFolder1;
  SConstString ShadingFolder2;
  SConstString ShadingFolder3;
  SConstString AnimFile;
  SConstString AnimFolder0;
  SConstString AnimFolder1;
  SConstString AnimFolder2;
...
struct NPlugAnim_SCurve {
  MwSArray<NPlugAnim_SKeyframe> Keys;
};

struct NPlugAnim_SKeyframe {
  float InTangent;
  float InWeight;
  float OutTangent;
  float OutWeight;
...
struct SPlugParticleSimulatedSmokeModel {
  ...
  float Gravity;
  SPlugCurveSimpleInPlace7 ParticleSizeOverLife;
  SPlugCurveSimpleInPlace7 ParticleAlphaOverLife;
  ...
  SPlugCurveSimpleInPlace7 FilamentStrengthOverLife;
...
struct SPlugParticleRenderModel {
  ...
  SPlugCurveSimpleInPlace7 MeshScaleOverLife;
  SPlugCurveSimpleInPlace7 MeshRampMinOverLife;
  SPlugCurveSimpleInPlace7 MeshRampMaxOverLife;
  iso4 MeshLocOffset;
  ...
  SPlugCurveSimpleInPlace4 IntensityFilter;
  float SizeBirth;
  float SizeBirthVariation;
  bool SizeBirthUseEmissionZone;
  float SizeBirthEmissionZoneScale;
  bool SizeBirthUseIntensity;
  SPlugCurveSimpleInPlace7 SizeBirthFromSpeedKmh;
  float SizeK;
  SPlugCurveSimpleInPlace4 SizeOverLife;
  bool SizeUseSizeX;
  SPlugCurveSimpleInPlace4 SizeXOverLife;
  float BeamLengthSpeedScale;
  float BeamLengthMax;
  float RollSpeedBirth;
  float RollSpeedBirthVariation;
  SPlugCurveColorGradient ColorGradient;
  ...
  SPlugCurveSimpleInPlace4 TransparencyOverLife;
  float UScaleDist;
  float VScaleDist;
  float WaterSplashVelY;
  CGxLightBall* Light;
  SPlugCurveSimpleInPlace4 LightRadiusOverLife;
  SPlugCurveColorGradient LightColorOverLife;
  bool LightUseEmitterHue;
  bool LightColorModulateWithTransparency;
};

struct SPlugCurveSimpleInPlace4 : public SPlugCurveSimple {
};

struct SPlugCurveColorGradient {
  float Xs_1_;
  float Xs_2_;
  vec3 Ys_0_;
  vec3 Ys_1_;
...
struct SPlugParticleSpawnModel {
  ...
  float MinDist;
  iso4 LocOffset;
  SPlugCurveSimpleInPlace4 IntensityFromSpawnNormLife;
};
...
struct NHmsLightMapCache_SFrame {
  ...
  const ELocalLight_Storage LocalLight_Storage;
  const ELocalLight_Switch LocalLight_Switch;
  const vec3 LAmbient;
...
enum class EPlugPainterLayer_Type {
  Draw = 0,
  VFX = 1,
  Skidmarks = 2,
  Tyres = 3,
...
enum class NRootSign::EParamType {
  Draw_CBuffer = 0,
  Shader_CBuffer = 1,
...
enum class EPlugAnimRigNodeType {
  JointRotateFrom = 0,
  JointRotate = 1,
  JointAlignTo = 2,
  JointTranslate = 3,
...
enum class EExtractMotionMode {
  Absolute = 0,
  Additive_Delta = 1, // Additive Delta
};

enum class EExtractUnitTarget {
  Translation = 0,
  Rotation = 1,
};

enum class EExtractUnitAxis {
  XAxis = 0,
  YAxis = 1,
  ZAxis = 2,
};
...
enum class EFunnelType {
  EvaluateOnce = 0,
  UpdateOnce = 1,
  Combined = 2,
};

enum class ERigNodeAssertVarType {
  Bool = 0,
  Float = 1,
  Float3 = 2,
  String = 3,
...
enum class ELayeredBlendType {
  Override = 0,
  Additive = 1,
};

enum class ELayeredBlendContext {
  Local = 0,
  Global = 1,
  Ignore = 2,
};

enum class ERigNodeOperationType {
  Set = 0,
  Add = 1,
  Sub = 2,
  Mult = 3,
...
enum class ERigNodeAxisWorkspace {
  Global = 0,
  Parent = 1,
  Local = 2,
};

enum class ERigNodeLockWorkspace {
  World = 0,
  Global = 1,
  Parent = 2,
...
enum class ERigNodeLockType {
  Translation_And_Rotation = 0, // Translation And Rotation
  Translation = 1,
  Rotation = 2,
};

enum class ERigNodeIK2SolverMode {
  SolverAuto = 0,
  PoleVectorExpr = 1,
};

enum class EClipPlayAdditiveType {
  None = 0,
...
enum class ESiblingDistribution {
  None = 0,
  Alternate = 1,
  All = 2,
};
...
enum class EShaderTcType {
  None = 0,
  TransSubTexture = 1,
};

enum class EAnimFuncBase {
  Constant = 0,
  Linear = 1,
  EaseInQuad = 2,
  EaseOutQuad = 3,
...
enum class EDynaConstraintType {
  PivotJoint = 0,
  Spring = 1,
};

enum class EForceFieldType {
  Magnet = 0,
  _01 = 1,
};
...
enum class ELocalLight_Storage {
  None = 0,
  All = 1,
  Only_rgb_accum = 2, // Only rgb accum
};

enum class ELocalLight_Switch {
  On = 0,
  Off = 1,
  Unknown = 2,
};
